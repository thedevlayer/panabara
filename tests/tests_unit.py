...
class MixinsTest(TestCase):
    ...
    def test_CreateUpdateAjaxMixin(self):
        ...
        self.assertEqual(mystocks.count(), 1)
        ...
        # Object is created
        mystocks = MyStocks.objects.all()
        self.assertEqual(mystocks.count(), 2)
        ...
        MyStocks = MyStocks.objects.first()
        self.assertEqual(MyStocks.title, 'Life of Jane Doe')
        ...
        # Object is updated
        MyStocks = MyStocks.objects.first()
        self.assertEqual(MyStocks.title, 'Life of Jane and John Doe')
